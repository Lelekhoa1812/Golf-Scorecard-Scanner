...
if __name__ == "__main__":
    ...
    label_dir = os.path.join(script_dir, "../dataset/labelme/train") # Path to JSON labels
    src_dir = os.path.join(script_dir, "../dataset/images/train")    # Path to images
    output_dir = os.path.join(script_dir, "../dataset/yolo_labels")  # Output YOLO label files
